...
const productSubMenu = {
    columns: [
        [
            ...
            { title: '产品提案', icon: 'Edit', items: [{ title: '提案管理', path: '/product/proposal/manage' }, { title: '开发样拿样任务', path: '/product/proposal/sample-task' }, { title: '开发样处置', path: '/product/proposal/sample-disposal' }, { title: '开发样管理', path: '/product/proposal/sample-manage' }] },
