    ...
    <div class="page-body">
            ...
            <template #default="{ node, data }">
              <div class="tree-node-row" :class="{ selected: selectedDeptId === data.id }">
                <div class="node-left">
                  ...
                  <el-tag
                    v-if="data.members && data.members.length"
                    size="small"
                    type="info"
      ...
      <div class="dept-detail-panel">
        <template v-if="selectedDept">
          ...
          <!-- 子部门卡片列表 -->
          <div class="sub-dept-section" v-if="selectedDept.children && selectedDept.children.length">
            <div class="section-header">
              <span class="section-title">子部门</span>
              <span class="section-badge">{{ selectedDept.children.length }}</span>
            </div>
            <div class="sub-dept-cards">
              <div
              ...
              >
                ...
                <div class="sub-card-info">
                  <span class="sub-card-name">{{ child.name }}</span>
                  <span class="sub-card-count">{{ child.members ? child.members.length : 0 }} 人</span>
                </div>
                <el-icon class="sub-card-arrow"><ArrowRight /></el-icon>
              </div>
            </div>
          </div>
          ...
          <div class="member-section">
            <div class="section-header">
              ...
              <span class="section-badge">{{ selectedDept.members ? selectedDept.members.length : 0 }}</span>
...
const deptTree = ref<Department[]>([
  {
    id: 1, name: '总经办', type: '职能部门', leader: '张三丰', phone: '010-12345678',
    location: '上海总部 A栋 18F',
    ...
    children: [
      {
        id: 11, name: '战略发展部', type: '职能部门', leader: '赵战略', phone: '010-11111111',
        location: '上海总部 A栋 17F', desc: '负责公司中长期战略规划与市场分析。',
        sort: 0,
        members: [
  ...
  {
    id: 2, name: '产品中心', type: '事业部', leader: '王产品', phone: '021-88888888',
    location: '上海总部 B栋 6F',
    ...
    children: [
      {
        id: 21, name: 'Amazon 运营组', type: '业务团队', leader: '刘亚马逊', phone: '021-22222222',
        location: '上海总部 B栋 5F', desc: '负责 Amazon 平台的商品运营与提案管理。',
        sort: 0,
        members: [
      ...
      {
        id: 22, name: 'TikTok 运营组', type: '业务团队', leader: '周抖音', phone: '021-33333333',
        location: '上海总部 B栋 5F', desc: '负责 TikTok Shop 平台的商品运营与内容提案。',
        sort: 1,
        members: [
  ...
  {
    id: 3, name: '供应链部', type: '职能部门', leader: '钱供应', phone: '021-55555555',
    location: '上海总部 C栋 3F',
    ...
    children: [
      {
        id: 31, name: '采购执行组', type: '业务团队', leader: '孟采购', phone: '021-55556666',
        location: '上海总部 C栋 2F', desc: '负责日常采购订单执行与供应商沟通。',
        sort: 0,
        members: [
  ...
  {
    id: 4, name: '财务部', type: '职能部门', leader: '余财务', phone: '021-66666666',
    location: '上海总部 A栋 15F',
